...
export default function CuratedSetsBrowser(props: { sets: CuratedSet[] }) {
  ...
  const getPuzzle = async () => {
    ...
    if (selectedThemes.length > 0)
      params = {
        ...params,
        themes: `[${selectedThemes.map((t) => `"${t}"`).join(',')}]`,
      }
    if (id) params = { id }
      ...
      <div className="flex max-h-[80vh] w-fit flex-col gap-2 border-r border-gray-300 p-2">
        ...
        <div className="flex flex-row items-center gap-1">
          ...
          <input
            ...
            id="puzzleId"
            name="puzzleId"
            placeholder="OVERRIDE ALL THE ABOVE"
            value={id}
            ...
            <div className="">
              {puzzle && (
                <div className="flex flex-col">
                  <p className="text-lg font-bold underline">Puzzle Details</p>
                  <p>
